...
import modeli.ModelTabeleRadnikEkspo;
 ...
 */
public class PrikaziRadnike extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrikaziRadnike.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PrikaziRadnike().setVisible(true);
            }
        });
    }
    ...
    private void popuniTabelu() {
        try {
            ...
            zahtev.setOperation(Operacije.GET_ALL_RADNIK_EKSPO);

            Komunikacija.getInstance().posaljiZahtev(zahtev);
            Response odgovor = Komunikacija.getInstance().primiOdgovor();
            ArrayList<RadnikEkspo> radnici = (ArrayList<RadnikEkspo>) odgovor.getResult();
            
            tblRadnici.setModel(new ModelTabeleRadnikEkspo(radnici));
        }catch(Exception ex){
